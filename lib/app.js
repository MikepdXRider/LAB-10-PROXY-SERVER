...
const { mungeLocationData, mungeReviewData, mungeWeatherData } = require('./fetch-utils.js');
...
//     const responseObj = await request.get(`https://prescriptiontrails.org/api/filter/?by=coord&lat=${latitudeQuery}&lng=${longitudeQuery}&offset=0&count=5`);
    
//     // const businessDataArr = responseObj.body.businesses;

//     const mungedDataObj = mungeReviewData(responseObj);
